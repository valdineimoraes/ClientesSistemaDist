...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { cliente: @venda.cliente, produto: @venda.produto, qtde: @venda.qtde, total: @venda.total, valor: @venda.valor } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente: @venda.cliente, produto: @venda.produto, qtde: @venda.qtde, total: @venda.total, valor: @venda.valor } }
